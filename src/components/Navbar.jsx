      ...
      items-center max-w-7x1 mx-auto'>
        ...
        onClick={()=>{
          ...
          <p className='text-white text-[14px] font-bold cursor-pointer'>
            Anjith B<span  className='sm:block text-[12px] hidden'>| web developer</span>
          </p>
        </Link>
        ...
        {navLinks.map((Link) => (
          <li
            ...
            ? "text-white" : "text-secondary"} hover:text-white text-[14px]
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          ...
          <div className={`${!toggle ? 'hidden' : 'flex'} p-6 black-gradient absolute top-20 right-0 mx-4 my-y min-w[140px] z-10 rounded-xl`}>
